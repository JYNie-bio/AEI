...
traindata=pd.read_csv("RS_811/14880file_ARGanno_copynumber_SNPmatrix959090_YesNoNA_addPhenotype_" + arguments[1] + "_train.txt",sep='\t', header=0,index_col=0, keep_default_na=False, dtype=CategoricalDtype())
verifytestdata=pd.read_csv("RS_811/14880file_ARGanno_copynumber_SNPmatrix959090_YesNoNA_addPhenotype_" + arguments[1] + "_verify_test.txt",sep='\t', header=0,index_col=0, keep_default_na=False, dtype=CategoricalDtype())
...
df0_sorted.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_feature_importances_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
df.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
combined_df.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top5feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top10feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top20feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top30feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top40feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_copynumber_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top50feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
