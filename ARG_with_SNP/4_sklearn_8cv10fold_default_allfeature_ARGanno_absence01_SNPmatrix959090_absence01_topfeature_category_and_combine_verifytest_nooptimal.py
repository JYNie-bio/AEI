...
df0_sorted.to_csv("AllFeature_nooptimal/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_absence01_"+ arguments[1] +"_fold_" + arguments[2] + "_feature_importances_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
df.to_csv("AllFeature_nooptimal/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_absence01_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
combined_df.to_csv("AllFeature_nooptimal/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_absence01_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
