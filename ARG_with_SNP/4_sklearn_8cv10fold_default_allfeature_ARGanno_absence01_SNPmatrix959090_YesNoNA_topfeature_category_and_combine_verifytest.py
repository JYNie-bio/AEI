...
df0_sorted.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_feature_importances_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
df.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
combined_df.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_category_and_combine_verifytest.txt", sep='\t', index=True, header=True)
...
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top5feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top10feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top20feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top30feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top40feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature_YesNoNA/XGBoost_10fold_crossvalidation_default_hyperparameter_ARGanno_absence01_SNPmatrix959090_YesNoNA_"+ arguments[1] +"_fold_" + arguments[2] + "_top50feature_category_and_combine_verifytest.txt", sep='\t', index=False, header=True)
