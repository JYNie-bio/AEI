...
my %hashprotein;
my %hash;
open INPUT3,"~/Feature_analysis/Salmonella_enterica_all_checkmPass_20231128_prokkapath_info_haveyear_havecountry_2014_arg_last_use_result_last.txt" or die $!;
while(<INPUT3>){
        chomp;
        my @arr=split(/\t/);
...
open OUTPUT,">~/Feature_analysis/Salmonella_public_184251_mgeARGinfo_addpos0_202605.txt";
...
open INPUT,"~/Feature_analysis/Salmonella_public_184251_mgeARGinfo_addpos0_202605.txt";
open OUTPUT,">~/Feature_analysis/Salmonella_public_184251_mgeARGinfo_addpos_202605.txt";
my %temphash;
while(<INPUT>){
        chomp;
        if(/^Genome/){
