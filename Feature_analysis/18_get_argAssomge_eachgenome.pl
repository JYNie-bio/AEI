...
#argfile: GCA_000732045.2_Salmonella_RefSeq_add_prokka_arg_fromdiamond_last_use_result.txt
#MGEmergedfile: GCA_001034585.1_MGE_merged_site.txt
#outfile: GCA_001034585.1_MGE_merged_ARGcombine_result.txt

my $sample=$MGEmergedfile;
$sample=~s/_MGE_merged_site.txt//;
