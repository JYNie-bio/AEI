...
fold_traindata=pd.read_csv("AllFeature/XGBoost_ARG_copynumber_fold_" + arguments[2] + "_train_samples_10fold_" + arguments[1] + ".txt",sep='\t', header=0,index_col=0)
fold_valdata=pd.read_csv("AllFeature/XGBoost_ARG_copynumber_fold_" + arguments[2] + "_val_samples_10fold_" + arguments[1] + ".txt",sep='\t', header=0,index_col=0)
...
verifytestdata=pd.read_csv("RS_811/14880file_ARGanno_Protein_result_copynumber_addPhenotype_" + arguments[1] + "_verify_test.txt",sep='\t', header=0,index_col=0)
...
df0_sorted.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_feature_importances_verifytest.txt", sep='\t', index=True, header=True)
...
df.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_verifytest.txt", sep='\t', index=True, header=True)
...
combined_df.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_topfeature_verifytest.txt", sep='\t', index=True, header=True)
...
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top5feature_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top10feature_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top20feature_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top30feature_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top40feature_verifytest.txt", sep='\t', index=False, header=True)
...
print("XGBoost Best Accuracy:", xgb_grid.best_score_)
results_XGBoost = pd.DataFrame(xgb_grid.cv_results_)
results_XGBoost.to_csv("AllFeature/XGBoost_10fold_crossvalidation_default_hyperparameter_ARG_copynumber_"+ arguments[1] +"_fold_" + arguments[2] + "_top50feature_verifytest.txt", sep='\t', index=False, header=True)
